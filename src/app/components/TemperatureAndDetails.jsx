    ...
    <div>
       ...
       justify-between text-white py-3'>
        ...
        <div className='flex flex-col space-y-2'>
         ...
         justify-center'>
            ...
            Real fell:
            <span className='font-medium ml-1'>32<sup>o</sup></span>
             </div>
      ...
      space-x-2 text-white text-sm py-3'>
        ...
        <UilSun />
         ...
         <UilSun />
          <p className='font-light'>
            High: <span className='font-medium ml-1'>45<sup>o</sup></span>
            </p>
         <p className='font-light'>|</p>
            
         <UilSun />
          <p className='font-light'>
            Low: <span className='font-medium ml-1'>40<sup>o</sup></span>
            </p>
